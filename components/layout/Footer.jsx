...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: faGithub, href: 'https://github.com/Veddkuknur', label: 'GitHub' },
    { icon: faLinkedin, href: 'https://linkedin.com/in/veddkuknur', label: 'LinkedIn' },
    { icon: faEnvelope, href: 'mailto:veddkuknur@gmail.com', label: 'Email' },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            <Link href="/" className="inline-block">
              <span className="text-xl font-display font-bold text-light-text dark:text-ghost-white">
                Vedd<span className="text-gradient"> Kuknur</span>
              </span>
            </Link>
            <p className="mt-4 text-light-text-secondary dark:text-muted-steel max-w-xs">
              Software Developer & CS Student passionate about building scalable systems and impactful applications.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-light-border dark:border-slate-700/50 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-light-text-secondary dark:text-muted-steel">
            © {currentYear} Vedd Kuknur. All rights reserved.
          </p>
          <p className="text-sm text-light-text-secondary dark:text-muted-steel">
