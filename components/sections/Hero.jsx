...
export default function Hero({ content }) {
  ...
  const defaultMetadata = {
    ...
    subtitle: 'Building scalable systems and impactful applications. From optimizing ad-targeting pipelines to creating AI-powered healthcare platforms.',
    profileImage: '/images/vedd.jpeg',
  };
  ...
  const scrollToContent = () => {
    const nextSection = document.getElementById('impact-showcase');
    if (nextSection) {
  ...
  const socialLinks = [
    { href: 'https://github.com/Veddkuknur', icon: faGithub, label: 'GitHub' },
    { href: 'https://www.linkedin.com/in/veddkuknur', icon: faLinkedinIn, label: 'LinkedIn' },
  ];
