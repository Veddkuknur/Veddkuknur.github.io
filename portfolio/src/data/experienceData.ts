export const experienceData = [
  ...
  },
  {
    ...
    club: "SPL (Single Parent Life)",
    points: [
      "Developed and launched a cross-platform mobile app (iOS/Android) to connect single parents with shared interests, mitigating isolation and fostering community.",
      "Implemented account authentication, media storage, and real-time messaging using Firebase.",
      "Built the frontend and core business logic in Flutter, compiling to native code for seamless iOS and Android experiences.",
      "Integrated Maps API for event geolocation and location-based user matching, promoting in-person gatherings.",
      "Leveraged Firebase Realtime Database for efficient data storage and retrieval, ensuring scalable user interactions."
    ]
  },
  {
    gridRow: 5,
    ...
    club: "TATA Consulting Engineers Limited",
    points: [
