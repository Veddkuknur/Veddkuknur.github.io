...
export default function ContactClient({ aboutContent }) {
  ...
  const socialLinks = [
    { href: 'https://github.com/Veddkuknur', icon: faGithub, label: 'GitHub', color: 'hover:text-gray-900 dark:hover:text-white' },
    { href: 'https://www.linkedin.com/in/veddkuknur', icon: faLinkedinIn, label: 'LinkedIn', color: 'hover:text-blue-600' },
  ];
