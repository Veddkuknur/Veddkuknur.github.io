          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-light-text-secondary dark:text-muted-steel mb-4 leading-relaxed">
                I'm a Computer Science student at the University of Alberta and a Software Developer Intern at INVIDI Technologies, where I work on backend services, cloud infrastructure, and frontend dashboards.
              </p>

              <p className="text-base text-light-text-secondary dark:text-muted-steel mb-6 leading-relaxed">
                My work focuses on building scalable systems, optimizing performance, and creating impactful applications. I'm passionate about full-stack development, cloud infrastructure, and privacy-preserving machine learning.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a
                  href="https://github.com/Veddkuknur"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/veddkuknur"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-secondary inline-flex items-center gap-2"
                >
